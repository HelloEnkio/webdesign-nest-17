...
const StatItem: React.FC<StatItemProps> = ({
  ...
  return <div className="space-y-2 p-5 rounded-xl bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-md shadow-lg border border-white/20 hover:border-teal-300/30 hover:shadow-teal-400/10 transition-all duration-300 group">
