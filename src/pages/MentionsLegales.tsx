      ...
      <main className="flex-grow pt-24">
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Le site web Enkio est édité par la société Enkio, société à responsabilité limitée au capital de 10 000 euros, 
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Le site Enkio est hébergé par la société Hébergement Pro, société par actions simplifiée au capital de 50 000 euros, 
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              L'ensemble du contenu du site Enkio (textes, graphismes, logos, images, vidéos, etc.) est protégé par le droit 
              d'auteur et est la propriété exclusive de Enkio ou de ses partenaires.
            </p>
            <p className="mb-4">
              Toute reproduction, distribution, modification, adaptation, retransmission ou publication, même partielle, de ces 
              différents éléments est strictement interdite sans l'accord exprès par écrit de Enkio.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              Enkio s'efforce d'assurer au mieux de ses possibilités l'exactitude et la mise à jour des informations diffusées 
              sur son site, dont elle se réserve le droit de corriger le contenu à tout moment et sans préavis.
            </p>
            <p className="mb-4">
              Enkio décline toute responsabilité pour tout dommage résultant d'une intrusion frauduleuse d'un tiers ayant 
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              réseau Internet ne sauraient engager la responsabilité de Enkio.
            </p>
          </section>
